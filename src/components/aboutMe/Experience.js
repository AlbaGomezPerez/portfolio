                        ...
                        <Timeline mode="alternate" className="timeline">
                            <Timeline.Item>
                                <span className="experience-item"
                                      data-aos="experience-animation">Formación Angular</span>
                                <p className="dates experience-item" data-aos="experience-animation">Mayo - Junio 2020.
                                    <br></br> Udemy</p>
                            </Timeline.Item>
                            <Timeline.Item>
                                <span className="experience-item"
                                      data-aos="experience-animation-left">Formación React</span>
                                <p className="dates experience-item" data-aos="experience-animation-left">Marzo - Abril
                                    2020.
                                    <br></br> Udemy</p>
                            </Timeline.Item>
                            <Timeline.Item>
                                <span className="experience-item" data-aos="experience-animation">Desarrollador Front-End</span>
                                <p className="dates experience-item" data-aos="experience-animation">Enero - Febrero
                                    2020.
                                    <br></br> Rentger</p>
                            </Timeline.Item>
                            <Timeline.Item>
                                <span className="experience-item" data-aos="experience-animation-left">Bootcamp desarrollo Front-End</span>
                                <p className="dates experience-item" data-aos="experience-animation-left">Junio -
                                    Diciembre 2019.
                                    <br></br> Adalab Digital</p>
                            </Timeline.Item>
                            <Timeline.Item>
                                <span className="experience-item"
                                      data-aos="experience-animation">Director creativo</span>
                                <p className="dates experience-item" data-aos="experience-animation">Diciembre 2016 -
                                    Junio 2019.
                            ...
                            <Timeline.Item>
                                ...
                                <p className="dates experience-item" data-aos="experience-animation-left">Septiembre
                                    2010 - Junio 2015.
